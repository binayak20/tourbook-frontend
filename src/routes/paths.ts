...
export const PRIVATE_ROUTES = {
	...
	TOURS_TYPES: 'tours-administration/tours/types',
	TOURS_TYPES_CREATE: 'tours-administration/tours/types/create',
	TOURS_TYPES_UPDATE: 'tours-administration/tours/types/edit/:id',
