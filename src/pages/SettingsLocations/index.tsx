...
import { LOCATIONS_SETTINGS_ROUTES, locationSettingsRoutes, MENU_ITEMS } from './contstants';
...
const SettingsLocation = () => {
	return (
		<Routes>
			...
			>
				<>
					<Route path='' element={<Navigate to={LOCATIONS_SETTINGS_ROUTES.LOCATIONS} replace />} />
