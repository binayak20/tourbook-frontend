...
import TicketsTab from './AttachmentsAndTicketsModalTabs/TicketsTab';
import type { TabsProps } from 'antd';
import AttachmentsTab from './AttachmentsAndTicketsModalTabs/AttachmentsTab';
import { useTranslation } from 'react-i18next';
// import { useParams } from 'react-router-dom';

const AttachmentsAndTicketsViewModal: FC<ModalProps> = (props) => {
	...
	const items: TabsProps['items'] = [
		{
			...
			children: <TicketsTab onCancel={props.onCancel} />,
		},
		{
			key: '2',
			label: (
			...
			children: <AttachmentsTab onCancel={props.onCancel} />,
		},
	];
...
export default AttachmentsAndTicketsViewModal;
